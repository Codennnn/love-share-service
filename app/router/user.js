...
module.exports = app => {
  ...
  get('/api/goods/list/by_filter', goods.getGoodsListByFilter)
  post('/api/goods/list/by_school_or_category', goods.getGoodsListBySchoolOrCategory)
  ...
  put('/api/goods/comment/change', goods.changeComment)
